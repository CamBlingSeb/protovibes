...
export default function ShowHistoryButton({
    handleShow
}: ShowHistoryButtonProps): JSX.Element {
    return (
        <div className={cx('text-end py-2', classes.dashHistory)}>
            <button className={cx(classes.dashHistoryButton)} onClick={handleShow}>
